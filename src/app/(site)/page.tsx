    ...
    <>
        <section className='overflow-hidden px-4 sm:px-6 mt-10 sm:flex sm:flex-col gap-4 md: justify-center md:items-center'>
            ...
            <div className='bg-white p-[2px] mt-6 rounded-xl bg-gradient-to-r from-primary to-brand-primaryBlue sm:w-[300px]'>
                <Button variant='btn-secondary' className='w-full rounded-[10px] p-6 text-xl bg-background'>Get Potion Free</Button>
            </div>
        ...
        <section className='relative'>
            ...
            '>{[...Array(2)].map((arr) => <div key={arr} className='flex flex-nowrap animate-slide'>
                {CLIENTS.map((client) => <div key={client.alt} className='relative w-[150px] m-20 shrink-0 flex items-center'>
        ...
        <section className='px-4 sm:px-6 flex justify-center items-center flex-col relative'>
            ...
            <TitleSection 
                ...
                pill="Features"
            />
            <div className='mt-10 max-w-[450px] flex justify-center items-center relative sm:ml-0 rounded-2xl bg-washed-purple-300/10 p-1.5'>
